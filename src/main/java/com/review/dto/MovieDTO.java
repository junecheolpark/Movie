...
public MovieDTO(String movieCd, String movieNm, String movieNmEn, String prdtYear, String openDt, String nationAlt,
		String genreAlt, String directors) {
	super();
