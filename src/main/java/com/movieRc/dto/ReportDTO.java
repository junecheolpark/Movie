...
public class ReportDTO {
    ...
    public ReportDTO(int seq_report, String category_check, String rp_content, String user_id, int seq_review, int seq_comment, int seq_post, String user_category) {
    ...
    public String toString() {
        return seq_report + " : " + category_check + " : " + rp_content + " : " + user_id + " : " + seq_review + " : " + seq_comment + " : " + seq_post + " : " + user_category;
    }
