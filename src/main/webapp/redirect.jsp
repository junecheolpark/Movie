		...
		<div class="container">
			<div class="row">
				...
				<div class="col-2">
					<h5>계정</h5>
					<ul class="nav flex-column">
						<li class="nav-item mb-2"><a href="/Member/login.jsp"
						...
						<li class="nav-item mb-2"><a href="/Member/findId.jsp"
							class="nav-link p-0">아이디 찾기</a></li>
						<li class="nav-item mb-2"><a href="/Member/findPw.jsp"
				...
				<div class="col-2">
					...
					<ul class="nav flex-column">
						...
						<li class="nav-item mb-2"><a href="/post/post.jsp"
