...
<body>
	...
	<div class="contentDiv row justify-content-center m-0">
		<div class="content1 col-11">
			<div id="carouselExampleIndicators" class="carousel slide w-60" data-bs-ride="true">
				...
				<div class="carousel-inner video">
					<div class="carousel-item active video-container">
						<iframe width="560" height="315" src="https://www.youtube.com/embed/mI9oyFMUlfg?autoplay=1" title="YouTube video player"
							frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
							allowfullscreen></iframe>
					</div>
					<div class="carousel-item video-container">
						<iframe width="560" height="315" src="https://www.youtube.com/embed/aw9j_23nORs" title="YouTube video player"
							frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
							allowfullscreen></iframe>
					</div>
					<div class="carousel-item video-container">
						<iframe width="560" height="315" src="https://www.youtube.com/embed/DpVAb7Bi5UQ" title="YouTube video player"
							frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
							allowfullscreen></iframe>
					</div>
				</div>
		...
		<div class="content2 col-11">
			...
			<div class="movieDiv slider" id="movieDiv1">
						...
						<c:if test="${i eq movie.key}">
							<a href="/detailView.re?movieCd=${movie.value['movieDTO'].movieCd}">
								<div class="movie slider_item">
									<div class="imgContainer" id="${movie.value['movieDTO'].movieCd}a" data-value="${movie.value['movieDTO'].movieNm}">
									...
									<div class="product">
										...
										<div class="avgPoint" data-value='${movie.value["avg"]}'>
											<span class="star"></span> <span><fmt:formatNumber value="${movie.value['avg']}" type="pattern" pattern="0.00" />
								...
								<a href="/detailView.re?movieCd=${review.value['movieDTO'].movieCd}">
									<div class="review slider_item">
										<div class="review_reviewer">
											<div class="reviewer_id">${review.value['reviewDTO'].user_nickname}</div>
		...
		<div class="content4 col-11">
			...
			<div class="movieDiv slider" id="movieDiv3">
				<c:forEach items="${hashMap3}" var="movie">
					<c:forEach var="i" begin="0" end="9" step="1">
						<c:if test="${i eq movie.key}">
							<a href="/detailView.re?movieCd=${movie.value['movieDTO'].movieCd}">
								<div class="movie slider_item">
									<div class="imgContainer" id="${movie.value['movieDTO'].movieCd}b" data-value="${movie.value['movieDTO'].movieNm}">
										<img src="/images/NoImg.webp" alt="">
									</div>
									<div class="product">
										<div class="category">
						...
						<c:if test="${i eq topic.key}">
							<div class="topic col-11 col-lg-5">
								<div class="topicTitle">
									<a href="/detailPost.po?seq_post=${topic.value['postDTO'].seq_post}">${topic.value['postDTO'].p_title}</a>
								</div>
								<div class="topicStatus">
									<span>UP ${topic.value['like']} DOWN ${topic.value['hate']} COMMENT ${topic.value['comment']} VIEW
    ...
    $.each($(".imgContainer"), function () {
        let movies = $(this).attr('data-value');
        let movies_id = $(this).attr('id');
    		...
    		data : {query : movies},
    				success : function(json) {
    					$.each(json.items,function(i,item) {
    						...
    						if(item.image){
    							$("#"+movies_id).empty();
    							$("#"+movies_id).append('<img src="' +item.image+ '"/>');
    							console.log("id:", movies_id);
    						}
