						...
						<div class="row align-items-center justify-content-center">
							...
							<div class="col-auto">
								<c:if test="${not empty loginSession}">
									...
									<a href="" class=""> <img class="img-fluid" id="myPageIcon" src="/images\마이페이지.png">
									</a>
								</c:if>
							</div>
				...
				<div class="row">
					<div class="col-2">
						...
						<ul class="nav flex-column">
							<li class="nav-item mb-2"><a href="/search.movie?s_type=genreAlt&curPage=1&val=코미디" class="nav-link p-0">코믹</a></li>
