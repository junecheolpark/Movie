	...
	<div class="content">
		...
		<div class="content-header">
			<div class="row">
				<div class="col-9"></div>
				<div class="col-3">
					<select class="form-select list" aria-label="Default select example" id="listItem">
		...
		<div class="content-footer2">
					...
					<nav>
						<ul class="pagination justify-content-center">
							<c:if test="${naviMap.needPrev eq true}">
								<li class="page-item"><a class="page-link" href="/post.po?curPage=${naviMap.startNavi-1}&&listItem=${listItem}">Prev</a>
								</li>
								<%-- 현재 6페이지에 있는 상태에서 이전 버튼을 클릭했음 ->  5페이지로 이동 --%>
							</c:if>

							<c:forEach var="pageNum" begin="${naviMap.startNavi}" end="${naviMap.endNavi}" step="1">
								<li class="page-item"><a class="page-link" href="/post.po?curPage=${pageNum}&&listItem=${listItem}">${pageNum}</a></li>
							</c:forEach>

							<c:if test="${naviMap.needNext eq true}">
								<li class="page-item"><a class="page-link" href="/post.po?curPage=${naviMap.endNavi+1}&&listItem=${listItem}">Next</a>
								</li>
							</c:if>
						</ul>
					</nav>
			...
			<div class="row">
				...
				<div class="col-2"></div>
				<div class="col-8">
					<select class="form-select search-method" id="searchValue" aria-label="Default select example" name="searchOption">
