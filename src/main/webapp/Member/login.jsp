    ...
    <div class="container">
        ...
        <nav id="menu" class="navbar navbar-expand-lg w-100 navbar-dark" aria-label="Main navigation">
            <div class="row w-100 align-items-center">
                ...
                <!-- logo -->
                <div class="col-2">
                    <a href="/home" class="d-flex align-items-center justify-content-start mb-2 mb-lg-0">
                        <img id="navLogo"
                ...
                <div class="col-5">
                    <div class="row">
                        ...
                        <div class="col-2">
                            <a href="" class="align-items-center "> <img class="img-fluid" id="cartIcon"
                                                                         src="/images/찜.png">
                                <!-- <p class="text-light" id="cart">찜한 영화</p> -->
                            </a> <a href="" class="align-items-center"> <img class="img-fluid" id="myPageIcon"
